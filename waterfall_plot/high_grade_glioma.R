...
data<-data[data$`Tumour Grade (HG/LG)`=="HG",]
...
data$`Tumour Type (WFP)`<-factor(data$`Tumour Type (WFP)`,
levels=c("DIA","DIG","FA","GG","GNC","GNT","OPG","PA","PMA","PXA","LGG NOS","IPD N/A","NR"))
...
plot<-ggplot(dat=data, mapping=aes(x=TablePosition)) +
      ...
      annotate("text", x=148, y=data$labelpositionPID, label="Patient ID", size=1.5, fontface="bold") +
      annotate("text", x=148, y=data$labelpositionAge, label="Age Group", size=1.5, fontface="bold") +
      annotate("text", x=148, y=data$labelpositionTumourResponse, label="Response", size=1.5, fontface="bold") +
      annotate("text", x=148, y=data$labelpositionBRAFI, label="BRAF Inhibitor", size=1.5, fontface="bold") +
      annotate("text", x=148, y=data$labelpositionMEKI, label="MEK Inhibitor", size=1.5, fontface="bold") +
      ...
      labs(title="Response to BRAFi Treatment by Diagnosis (High Grade)",
...
ggsave("WFP - High Grade.png",units = "in", width=12, height=8, dpi=1200)
